...
namespace Zadaca.Migrations
{
    ...
    [Migration("20221009144604_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Zadaca.Models.Author", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Zadaca.Models.Literature", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Zadaca.Models.Subject", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("AuthorLiterature", b =>
                {
                    b.HasOne("Zadaca.Models.Author", null)
                        .WithMany()
                        .HasForeignKey("AuthorsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Zadaca.Models.Literature", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Zadaca.Models.Literature", b =>
                {
                    b.HasOne("Zadaca.Models.Subject", null)
